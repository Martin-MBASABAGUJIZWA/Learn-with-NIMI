        ...
        <motion.div initial="hidden" animate="visible" variants={stagger}>
          ...
          <motion.div variants={fadeUp} className="mb-10">
            <div className="flex items-center gap-3 mb-2">
              <span className="w-10 h-10 bg-[var(--ds-brand-soft)] rounded-xl flex items-center justify-center text-[20px]">🔒</span>
              <span className="font-nunito text-[var(--ds-text-brand)] text-[11px] font-bold uppercase tracking-[0.18em]">Legal Document</span>
            </div>
          ...
          <motion.div variants={fadeUp} className="bg-[var(--ds-brand-subtle)] border border-[var(--ds-border-brand)] rounded-2xl p-5 mb-10">
            <p className="font-baloo font-black text-[var(--ds-text-brand)] text-[16px] mb-1">🌿 Our commitment to your family</p>
            <p className="font-nunito text-[var(--ds-text-brand)] text-[14px] leading-relaxed">
          ...
          <Section title="1. Who We Are">
            ...
            <p>Registered in Rwanda. Contact us: <a href={`mailto:${CONTACT_EMAIL}`} className="text-[var(--ds-text-brand)] hover:underline">{CONTACT_EMAIL}</a></p>
          </Section>
          ...
          <Section title="4. Children's Privacy (COPPA & GDPR)">
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>Parents may review, update, or delete their child&apos;s information at any time by contacting us at <a href={`mailto:${CONTACT_EMAIL}`} className="text-[var(--ds-text-brand)] hover:underline">{CONTACT_EMAIL}</a>.</li>
            </ul>

            <div className="bg-[var(--ds-brand-subtle)] border border-[var(--ds-border-brand)] rounded-xl p-4 mt-3">
              <p className="font-baloo font-black text-[var(--ds-text-brand)] text-[14px] mb-1">GDPR — For Families in the European Economic Area</p>
              <p className="text-[var(--ds-text-brand)] text-[13px] leading-relaxed">Our lawful basis for processing your data is <em>contract performance</em> (delivering the service you subscribed to) and <em>legitimate interests</em> (platform security and fraud prevention). You have the right to access, correct, delete, or port your data at any time. Contact <a href={`mailto:${CONTACT_EMAIL}`} className="text-[var(--ds-text-brand)] underline">{CONTACT_EMAIL}</a> to exercise these rights.</p>
            </div>
          </Section>
          ...
          <Section title="9. Your Rights">
            ...
            <p className="mt-3">To exercise any of these rights, contact us at <a href={`mailto:${CONTACT_EMAIL}`} className="text-[var(--ds-text-brand)] hover:underline">{CONTACT_EMAIL}</a>. We will respond within 30 days.</p>
          </Section>
          ...
          <Section title="11. Contact Us">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-xl p-4 mt-2">
              ...
              <p className="text-gray-600 mt-1">Email: <a href={`mailto:${CONTACT_EMAIL}`} className="text-[var(--ds-text-brand)] hover:underline">{CONTACT_EMAIL}</a></p>
