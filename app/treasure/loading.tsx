      ...
      <div className="max-w-5xl mx-auto w-full pb-24">
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="leaf border border-[var(--ds-border-primary)] p-4 space-y-2 text-center">
        ...
        {/* Badge grid */}
        <div className="leaf-lg border border-[var(--ds-border-primary)] p-5 space-y-4 mb-6">
          <Bone className="h-6 w-36" />
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="leaf border border-[var(--ds-border-primary)] p-4 flex flex-col items-center gap-2">
