...
function UnsubscribeContent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--ds-surface-card)] px-4">
      <div className="bg-[var(--ds-surface-card)] rounded-2xl border border-[var(--ds-border-primary)] shadow-sm max-w-sm w-full p-8 text-center">
        ...
        {state === 'success' && (
          <>
            ...
            <h1 className="text-xl font-extrabold text-[var(--ds-text-primary)] mb-2">You&apos;re unsubscribed</h1>
        ...
        {state === 'already' && (
          <>
            <div className="text-4xl mb-4">👋</div>
            <h1 className="text-xl font-extrabold text-[var(--ds-text-primary)] mb-2">Already unsubscribed</h1>
            <p className="text-[var(--ds-text-secondary)] text-sm mb-6">
        ...
        {state === 'error' && (
          <>
            ...
            <h1 className="text-xl font-extrabold text-[var(--ds-text-primary)] mb-2">Link not found</h1>
            <p className="text-[var(--ds-text-secondary)] text-sm mb-6">
