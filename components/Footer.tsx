  ...
  return (
    <footer className={`fixed bottom-16 left-0 right-0 z-30 transition-all duration-300 ${
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-[var(--ds-surface-card)] border border-ds-border rounded-lg p-2 shadow-sm flex flex-col items-center">
          <div className="flex items-center text-[var(--ds-text-secondary)]">
          ...
          <div className="text-[var(--ds-text-secondary)] text-3xs mt-0.5">
