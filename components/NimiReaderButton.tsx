  ...
  return (
    <>
      ...
      <button
        ...
        className="bg-[var(--ds-brand-primary)] hover:bg-[var(--ds-brand-hover)] text-white text-sm md:text-base font-bold px-5 py-3 rounded-full shadow-lg flex items-center gap-2 transition-all duration-300 cursor-grab active:cursor-grabbing"
      >
