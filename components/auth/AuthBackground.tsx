...
const STARS: { className: string; size: string; color: string; delay: number }[] = [
  ...
  { className: "top-[8%] left-[27%]", size: "w-3 h-3", color: "text-[var(--ds-text-tertiary)]", delay: 0.4 },
  { className: "top-[6%] right-[22%]", size: "w-4 h-4", color: "text-[var(--ds-text-tertiary)]", delay: 0.8 },
  ...
  { className: "top-[22%] right-[6%]", size: "w-3 h-3", color: "text-[var(--ds-text-tertiary)]", delay: 0.7 },
  ...
  { className: "top-[35%] right-[4%]", size: "w-3 h-3", color: "text-[var(--ds-text-tertiary)]", delay: 1.3 },
