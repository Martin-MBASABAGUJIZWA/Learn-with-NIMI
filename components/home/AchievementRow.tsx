            ...
            {BADGES.map((b, i) => {
              ...
              return (
                <motion.div key={b.key}
                  {...m.badgeUnlock}
                  transition={{ ...m.badgeUnlock.transition, delay: 0.1 + i * 0.12 }}
                  className="flex flex-col items-center gap-1">
                  <motion.div
                    animate={is ? { scale: [1, 1.08, 1], rotate: [0, 3, -3, 0] } : {}}
                    transition={{ duration: DURATION.loopFloat, repeat: Infinity, delay: i * 0.5 }}
            ...
            <>
              <div className="relative w-20 h-20 overflow-hidden border-2 border-white/10 mb-2 shadow-lg" style={{ borderRadius: 'var(--leaf-r)' }}>
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/20">
                  <motion.div animate={{ y: [0, -3, 0] }} transition={{ duration: DURATION.loopBase, repeat: Infinity }}>
