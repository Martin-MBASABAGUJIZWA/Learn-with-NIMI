...
function CertificateVisual({ storyTitle, earned }: { storyTitle: string; earned: boolean }) {
  ...
  return (
    <div className="relative overflow-hidden border border-[var(--ds-border-primary)]/60 bg-gradient-to-br from-white via-[var(--ds-brand-soft)]/35 to-white shadow-card-2xl" style={{ borderRadius: 'var(--leaf-r)' }}>
      ...
      <div className="relative z-10 py-4 px-5 text-center">
        ...
        <p className="text-yellow-300 text-sm sm:text-base font-black">{t("storyCertCongrats")}</p>
        <p className="text-ds-text text-3xs sm:text-2xs font-bold">{t("storyCertYouEarned")}</p>
        <p className="text-[var(--ds-text-primary)] text-lg sm:text-1.5xl font-black mt-0.5">{t("storyCertTitle")}</p>

        <div className="w-32 h-0.5 bg-gradient-to-r from-transparent via-gray-300 to-transparent mx-auto my-2" />

        <p className="text-[var(--ds-text-tertiary)] text-4xs font-bold">{t("storyCertStoryLabel")}</p>
        <p className="text-yellow-300 text-xs sm:text-sm font-black uppercase">{storyTitle}</p>
        ...
        <div className="flex items-end justify-between mt-3 px-1 sm:px-4">
          <div className="flex flex-col items-center gap-0.5">
            ...
            <p className="text-[var(--ds-text-tertiary)] text-6xs">{t("storyCertSigned")}</p>
            <p className="text-ds-text text-4xs sm:text-3xs font-black italic">Nimi 💜</p>
          </div>
          <div className="flex flex-col items-center gap-0.5">
            ...
            <p className="text-[var(--ds-text-tertiary)] text-6xs">{t("storyCertSigned")}</p>
            <p className="text-ds-text text-4xs sm:text-3xs font-black italic">Piko 💜</p>
          </div>
        </div>
      </div>
      ...
      {!earned && (
        <div className="absolute inset-0 bg-[var(--ds-surface-card)]/60 flex items-center justify-center z-20" style={{ borderRadius: 'var(--leaf-r)' }}>
          <motion.div animate={{ scale: [1, 1.1, 1] }} transition={{ duration: 2, repeat: Infinity }}
            className="w-14 h-14 bg-[var(--ds-surface-card-hover)] rounded-full flex items-center justify-center border-2 border-[var(--ds-border-primary)] shadow-xl">
    ...
    <div className="relative overflow-hidden max-w-2xl mx-auto" style={{ borderRadius: 'var(--leaf-r)' }}>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-30 bg-gradient-to-t from-gray-900 via-gray-900/95 to-transparent rounded-b-2xl p-4 pt-10 shadow-[0_-8px_22px_rgba(15,23,42,0.18)]">
        <div className="text-center">
          <p className="text-yellow-300 text-base sm:text-lg font-black">
          ...
          <div className="flex items-center gap-2 justify-center mt-2">
            <div className="bg-[var(--ds-surface-card)]/20 rounded-full h-3 overflow-hidden flex-1 max-w-[200px]">
            ...
            <span className="text-yellow-300 text-sm font-black">{missionsComplete}/{totalMissions}</span>
          </div>
        </div>
      </div>
    </div>
