...
export default function LandingDemoSection() {
  ...
  return (
    <section className="relative bg-[var(--ds-surface-card)] px-5 sm:px-10 lg:px-14 py-16 sm:py-24 border-t border-[var(--ds-border-primary)] overflow-hidden">
          ...
          <motion.div variants={fadeUp} className="flex-1 text-center lg:text-left">
            ...
            <ul className="flex flex-col gap-3 mb-8 max-w-sm mx-auto lg:mx-0">
              {[
                ...
                <li key={text} className="flex items-center gap-3 font-nunito text-[14px] text-[var(--ds-text-secondary)]">
            ...
            <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
              <span className="flex items-center gap-1.5 font-nunito text-[var(--ds-text-tertiary)] text-[12px]">
                  ...
                  <button onClick={() => setPlaying(true)}
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="relative flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        <div className="absolute w-24 h-24 rounded-full bg-[var(--ds-surface-card)]/20 animate-ping" style={{ animationDuration: "2.2s" }} />
                        <div className="relative w-16 h-16 rounded-full bg-[var(--ds-surface-card)] shadow-2xl flex items-center justify-center">
