  ...
  if (insufficientData) {
    return (
      <div className="bg-[var(--ds-surface-card)] border border-ds-border p-6 shadow-ds-card flex flex-col items-center gap-3 text-center" style={{ borderRadius: "var(--leaf-r-lg)" }}>
        ...
        <p className="font-black text-ds-text text-base">Insights coming soon</p>
    ...
    return (
      <div className="bg-[var(--ds-surface-card)] border border-ds-border p-5 shadow-ds-card" style={{ borderRadius: "var(--leaf-r-lg)" }}>
        <div className="flex flex-col items-center gap-3 py-4 text-center">
          ...
          <p className="font-black text-ds-text text-mbase">Couldn&apos;t generate insights</p>
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-5">
        ...
        <div className="flex-1 min-w-0">
          <h2 className="font-black text-ds-text text-mlg leading-tight">Nimi&apos;s Observations</h2>
          {relativeTime && (
        ...
        <div className="space-y-3">
          {insights.map((insight, i) => {
            ...
            return (
              ...
              >
                <span className="text-1.5xl shrink-0 leading-none mt-0.5">{style.emoji}</span>
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    <p className={`font-black text-sm leading-tight ${style.text}`}>{insight.title}</p>
                    <span className={`text-4xs font-black uppercase tracking-wider px-2 py-0.5 rounded-full border ${style.pill} shrink-0`}>
                      {TYPE_STYLE[insight.type].label}
                    </span>
                  </div>
                  <p className={`text-xs leading-relaxed font-nunito ${style.text} opacity-85`}>
                    {insight.body}
                  </p>
                </div>
              </motion.div>
