...
const DEFAULTS: KitLayout = {
  ...
  champion:     { x: 918,  y: 428, font_size: 14, bold: true,  color: '#1a1a2e' },
  age:          { x: 918,  y: 461, font_size: 14, bold: true,  color: '#1a1a2e' },
  statut:       { x: 918,  y: 494, font_size: 14, bold: true,  color: '#16a34a' },
  vol:          { x: 918,  y: 527, font_size: 14, bold: true,  color: '#1a1a2e' },
  destination:  { x: 918,  y: 560, font_size: 12, bold: true,  color: '#1a1a2e' },
  livre:        { x: 918,  y: 593, font_size: 14, bold: true,  color: '#1a1a2e' },
  siege:        { x: 918,  y: 626, font_size: 14, bold: true,  color: '#1a1a2e' },
  porte:        { x: 918,  y: 659, font_size: 14, bold: true,  color: '#1a1a2e' },
  embarquement: { x: 918,  y: 692, font_size: 14, bold: true,  color: '#16a34a' },
  barcode:      { x: 703,  y: 735, w: 376, h: 35 },
