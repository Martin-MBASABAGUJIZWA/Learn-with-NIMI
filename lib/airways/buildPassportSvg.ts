...
<text x="${PAGE_W / 2}" y="168" text-anchor="middle"
  font-size="32" font-family="Arial Black,sans-serif" font-weight="900"
  fill="${GOLD}" letter-spacing="3">PASSEPORT VOYAGE</text>

<!-- NIMIPIKO large -->
<text x="${PAGE_W / 2}" y="240" text-anchor="middle"
  font-size="68" font-family="Arial Black,sans-serif" font-weight="900"
...
<text x="${PAGE_W / 2 - 100}" y="700" text-anchor="middle" font-size="13"
  font-family="Arial Black,sans-serif" fill="${GOLD}">NIMI</text>
<text x="${PAGE_W / 2}" y="700" text-anchor="middle" font-size="13"
  font-family="Arial Black,sans-serif" fill="${GOLD}">PIKO</text>
<text x="${PAGE_W / 2 + 100}" y="700" text-anchor="middle" font-size="13"
  font-family="Arial Black,sans-serif" fill="${GOLD}">ZILO</text>
...
<text x="${PAGE_W / 2}" y="850" text-anchor="middle"
  font-size="36" font-family="Arial Black,sans-serif" font-weight="900"
  fill="${GOLD}" letter-spacing="2">NIMIPIKO</text>

<!-- Tagline -->
<text x="${PAGE_W / 2}" y="890" text-anchor="middle"
  font-size="16" font-family="Georgia,serif" font-style="italic"
...
<text x="${PAGE_W / 2}" y="${PAGE_H - 50}" text-anchor="middle"
  font-size="14" font-family="Arial,sans-serif" fill="${GOLD}" opacity="0.5">
  GROW WITH EVERY STORY
</text>
<text x="${PAGE_W / 2}" y="${PAGE_H - 28}" text-anchor="middle"
  font-size="10" font-family="Arial,sans-serif" fill="${GOLD}" opacity="0.35">
  nimipiko.com
</text>
</svg>`;
}
...
<text x="${PAGE_W / 2}" y="62" text-anchor="middle"
  font-size="28" font-family="Arial Black,sans-serif" font-weight="900"
...
<!-- Name and details -->
<text x="250" y="155" font-size="12" font-family="Arial,sans-serif"
  fill="${GOLD}" font-weight="700" letter-spacing="2">NOM DU CHAMPION :</text>
<text x="250" y="185" font-size="26" font-family="Arial Black,sans-serif"
  font-weight="900" fill="${NAVY}">${esc(childName)}</text>

<line x1="248" y1="195" x2="${PAGE_W - 48}" y2="195" stroke="#D1D5DB" stroke-width="1"/>

<text x="250" y="230" font-size="12" font-family="Arial,sans-serif"
  fill="${GOLD}" font-weight="700" letter-spacing="2">NUMÉRO DU CHAMPION :</text>
<text x="250" y="258" font-size="22" font-family="Arial Black,sans-serif"
  font-weight="900" fill="${NAVY}">${esc(championNumber)}</text>

<text x="250" y="300" font-size="12" font-family="Arial,sans-serif"
  fill="${GOLD}" font-weight="700" letter-spacing="2">DATE DE CRÉATION :</text>
<text x="250" y="328" font-size="18" font-family="Arial Black,sans-serif"
...
<text x="${PAGE_W - 110}" y="372" text-anchor="middle"
  font-size="10" font-family="Arial,sans-serif" fill="${NAVY}" opacity="0.6">
  SCANNE POUR VOIR
</text>
...
<text x="${PAGE_W - 80}" y="${PAGE_H - 116}" text-anchor="middle"
  font-size="10" font-family="Arial,sans-serif" fill="${GREEN}" letter-spacing="0.5">NIMIPIKO</text>
<text x="${PAGE_W - 80}" y="${PAGE_H - 100}" text-anchor="middle" font-size="22">🌿</text>
<text x="${PAGE_W - 80}" y="${PAGE_H - 82}" text-anchor="middle"
  font-size="9" font-family="Arial,sans-serif" fill="${GREEN}" letter-spacing="0.5">OFFICIELLEMENT VALIDÉ</text>

<!-- Tagline at bottom -->
<text x="${PAGE_W / 2}" y="${PAGE_H - 30}" text-anchor="middle"
  font-size="13" font-family="Georgia,serif" font-style="italic"
...
export function buildPassportDestinationSvg(opts: {
  ...
  const nextStoryBlock = nextStory
    ? `<!-- VISA for next story -->
      ...
      <text x="50" y="802" font-size="11" font-family="Arial,sans-serif"
      ...
      <text x="335" y="863" text-anchor="middle"
        font-size="11" font-family="Arial,sans-serif" fill="${NAVY}" opacity="0.5">
        DESTINATION SUIVANTE :
      </text>
      <text x="335" y="883" text-anchor="middle"
        font-size="13" font-family="Arial Black,sans-serif" font-weight="900"
    ...
    : `<!-- All stories complete -->
      ...
      <text x="${PAGE_W / 2}" y="888" text-anchor="middle"
        font-size="14" font-family="Arial,sans-serif" fill="${NAVY}" opacity="0.7">
...
<text x="140" y="148" text-anchor="middle" font-size="12"
  font-family="Arial,sans-serif" fill="${GOLD}" font-weight="700" letter-spacing="2">LIVRE ${bookNum}</text>
...
<text x="440" y="148" text-anchor="middle" font-size="12"
  font-family="Arial,sans-serif" fill="${GOLD}" font-weight="700" letter-spacing="2">BADGE D'ATTITUDE</text>
${badgeBlock}
...
<text x="${PAGE_W / 2 - 110}" y="420" font-size="12"
  font-family="Arial,sans-serif" fill="${GOLD}" font-weight="700" letter-spacing="1">DATE DE VALIDATION</text>
<text x="${PAGE_W / 2 - 80}" y="450" font-size="22" text-anchor="middle">📅</text>
<text x="${PAGE_W / 2}" y="460" font-size="22" font-family="Arial Black,sans-serif"
...
<text x="${PAGE_W - 80}" y="458" text-anchor="middle"
  font-size="9" font-family="Arial,sans-serif" fill="${GREEN}" letter-spacing="0.5">NIMIPIKO</text>
<text x="${PAGE_W - 80}" y="475" text-anchor="middle" font-size="16">🌿</text>
<text x="${PAGE_W - 80}" y="490" text-anchor="middle"
  font-size="8" font-family="Arial,sans-serif" fill="${GREEN}" letter-spacing="0.3">OFFICIELLEMENT VALIDÉ</text>
...
<text x="120" y="488" text-anchor="middle" font-size="11"
  font-family="Arial,sans-serif" fill="${GREEN}" opacity="0.4" letter-spacing="0.5">NIMIPIKO</text>
...
<text x="${PAGE_W / 2}" y="790" text-anchor="middle"
  font-size="11" font-family="Arial,sans-serif" fill="${NAVY}" opacity="0.4">
...
<text x="${PAGE_W / 2}" y="${PAGE_H - 18}" text-anchor="middle"
  font-size="10" font-family="Arial,sans-serif" fill="${GOLD}" opacity="0.4">
  p. ${bookNum + 1} / 13
</text>
</svg>`;
}
